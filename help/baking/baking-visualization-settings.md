...
breadcrumb-title: ''
description: Obtenga información sobre cómo hacer un bake la configuración de visualización en Substance 3D Painter para previsualizar y depurar los resultados de hace un bake del mapa de malla.
helpx_creative_field: ""
helpx_description: Painter > Baking > Baking visualization settings
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Hacer un bake la configuración de visualización
...
# Hacer un bake la configuración de visualización

![](../assets/viewport-vizu.png)

La visualización Hacer un bake es un panel dentro del área de visualización de Painter en el modo Hacer un bake. Permite ajustar la configuración relacionada con la visualización de mallas en la ventana gráfica.

## Configuración general

| Configuración | Descripción |
| --- | --- |
| **Ocultar mallas de haga un bake** | Si se habilita, este icono ocultará la malla alta de la caja y de la caja en la ventana gráfica. <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r1-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../assets/hide-baking-meshes.png"/></div> |
...
<td> </td>
<td><p>Si se activa, las mallas de baja polietileno en las que se hacen un bake las mallas de alta polietileno serán visibles en la ventana gráfica. Si <b>Ocultar mallas de haga un bake</b> está habilitado, esta configuración también se habilita automáticamente para evitar que la ventana gráfica esté vacía.</p>
...
<td>Controla en qué medida la Oclusión ambiental hecha un bake contribuye al sombreado de malla de baja densidad en la ventana gráfica.</td>
</tr><tr><td><b>Normal doblada</b></td>
<td>Si está activada, utilice Normales dobladas hechas un bake para mejorar el sombreado de malla de baja densidad en la ventana gráfica.</td>
</tr><tr><td><b>Cantidad de difusión de normal doblada</b></td>
<td>Controla en qué medida las Normales dobladas afectan al sombreado difuso.</td>
</tr><tr><td><b>Cantidad especular de normal doblada</b></td>
<td>Controla en qué medida las Normales dobladas afectan al sombreado del specular.</td>
</tr></tbody></table>
