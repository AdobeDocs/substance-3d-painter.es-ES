...
>[!NOTE]
>
> Consulte [**Configuración del mapa de malla**](mesh-map-settings.md) para ver una lista completa de las opciones disponibles en los **paneles Configuración común** y **Configuración del mapa de malla**.

Hay paneles adicionales disponibles y se comportan del mismo modo que en **Modo de pintura**:

<table>
  <tr style="border: 0;">
    <td style="border: 0;" valign="top"><img src="../assets/right-bar.png" alt=""/></td>
    <td style="border: 0;" valign="top"><ul><li><a href="../interface/texture-set/texture-set-list.md"><strong>Lista Conjunto de texturas</strong></a></li><li>Disponible en la barra derecha:<ul><li><a href="../interface/miscellaneous/log.md"><strong>Registro</strong></a></li><li><a href="../interface/display-settings/display-settings.md"><strong>Configuración de la pantalla</strong></a></li><li><a href="../interface/history.md"><strong>Historial</strong></a></li></ul></li></ul></td>
  </tr>
</table>