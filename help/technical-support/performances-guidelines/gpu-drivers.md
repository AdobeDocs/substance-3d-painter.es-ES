...
breadcrumb-title: ''
description: Obtenga más información sobre la VRAM de la GPU y los requisitos de controlador para Substance 3D Painter con el fin de optimizar el rendimiento y la estabilidad del procesamiento.
...
Painter funciona transfiriendo texturas a la memoria de la GPU (VRAM) para realizar los cálculos (como operaciones de fusión para crear las texturas finales). Sin embargo, si la VRAM comienza a llenarse, las texturas no utilizadas se volverán a transferir a la RAM del equipo para liberar espacio de VRAM. Substance 3D Painter escribe y lee GB de datos cuando trabaja. Esto significa que tanto la capacidad de la VRAM (cantidad) como la velocidad del ancho de banda cuando se realizan transferencias son importantes. Puede utilizar herramientas como [MSI AfterBurner](https://www.msi.com/page/afterburner) para supervisar este comportamiento.
