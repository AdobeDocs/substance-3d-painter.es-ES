...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib Sampler - API del sombreador
...
# Lib Sampler - API del sombreador

## lib-sampler.glsl

**Funciones públicas:** *getAO* *getShadowFactor* *getGlossiness* *getRoughness* *getMetallic* *getAnisotropyLevel* *getAnisotropyAngle* *getOpacity* *getHeight* *getDisplacement* *getSpecularLevel* *getBaseColor* *getDiffuse* *getSpecularColor* *getScattering* *generateAnisotropicRoughness* *generateDiffuseColor* *generateSpecularColor*
...
Colores de fondo predeterminados cuando no hay datos en el canal (alfa es 0)
...
Devolver el brillo muestreado o un valor predeterminado
...
Devolver la rugosidad de la muestra o un valor predeterminado
...
Devolver muestra metálica o un valor predeterminado
...
Devolver ángulo de anisotropía muestreado o un valor predeterminado
...
Devolver la opacidad de la muestra o un valor predeterminado
...
Devolver height muestreado o un valor predeterminado
...
Devolver desplazamiento muestreado o un valor predeterminado
...
Ayudante para obtener oclusión ambiental para el sombreado
...
Obtener el factor de sombreado (espacio de pantalla)
...
Devolver color difuso muestreado o un valor predeterminado
...
Devolver el color de specular muestreado o un valor predeterminado
...
Generar rugosidad anisotrópica a partir de la rugosidad y el nivel de anisotropía
...
Generación del color del specular a partir de specular level dieléctrico, color base y factor metálico
...
Devolver un valor de dispersión muestreado o un valor predeterminado
