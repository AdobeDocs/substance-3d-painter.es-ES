...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib PBR - API del sombreador
...
# Lib PBR - API del sombreador

## lib-pbr.glsl

**Funciones públicas:** *normal\_distrib* *fresnel* *G1* *visibility* *horizonFading* *pbrComputeDiffuse* *pbrComputeSpecular* *pbrComputeBRDF*

Número de niveles mip en el mapa de envid.
...
Una int que representa el número de muestras realizadas para el cálculo de la aportación de specular. Cuanto más alta sea la calidad y el impacto en el rendimiento.
...
Valor utilizado para controlar la fuga de reflejo del specular a través de la superficie.
...
Importar desde biblioteca, otros parámetros
...
Funciones relacionadas con BRDF
...
Truco de desvanecimiento del horizonte de <https://marmosetco.tumblr.com/post/81245981087>
...
Calcula la luminancia difusa lamberciana al ojo del espectador
...
Calcula el reflejo del specular de las microfacetas al ojo del espectador
