---
helpx_url: "https://helpx.adobe.com/es/substance-3d-painter/scripting-and-development/api-reference/shader-api/libraries-shader-api/lib-pom-shader-api.html"
breadcrumb-title: ''
description: Acceda a la referencia de API del sombreador POM de labios de Substance 3D Painter para crear efectos de asignación de oclusión de paralaje en sombreados personalizados.
...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib Pom - API del sombreador
...
# Lib Pom - API del sombreador

## lib-pom.glsl

**Funciones públicas:** *getParallaxOffset* *applyParallaxOffset*
...
Parallax oclusión asignación de uniformes relacionados
...
Calcular el desplazamiento de las coordenadas de textura en función del paralaje
...
Actualizar coordenadas de textura de entrada con desplazamiento de paralaje
