...
## Definición del tipo de entrada V2F:
...
Por ejemplo, la ecuación de procesamiento más básica para calcular el color del fragmento es: *EmissiveColor + albedo \* diffuseShading + specularShading*
