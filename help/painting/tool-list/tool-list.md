...
Esta página detalla todas las herramientas de pintura disponibles y cómo utilizarlas.
...
| <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/icon-smudge.png" width="100px"/></div> | La [herramienta de difuminado](smudge-tool.md) te permite estirar, mezclar y desenfocar el color y otras propiedades del material. |
| <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r6-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/icon-clone.png" width="100px"/></div> | La [herramienta Clonar](clone-tool.md) te permite duplicar o parchear cualquier parte del material existente en la malla 3D. |
| <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r7-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/icon-materialpicker.png" width="100px"/></div> | El Selector de material permite copiar propiedades de material del proyecto desde la superficie de la malla 3D.  Se trata de una herramienta temporal; una vez seleccionado un color, se equipará la herramienta anterior. |
|  | [Máscara rápida](quick-mask.md) le permite crear una máscara temporal que proporciona más control sobre dónde puede aplicar la pintura. |
