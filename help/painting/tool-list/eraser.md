...
breadcrumb-title: ''
description: Usa la herramienta Borrador en Substance 3D Painter para eliminar la pintura y las texturas de tus modelos en 3D con un control de precisión.
...
El Borrador es una herramienta de pintura que borra u oculta lo que han pintado anteriormente otras herramientas. Esta herramienta solo afecta a una capa cada vez.

El Borrador comparte parámetros y comportamientos comunes con la herramienta de pintura. Para obtener más información sobre el pincel, los controles alfa y stencil echan un vistazo a la [página de la herramienta Pintura](paint-brush.md).
...
> * Un filtro Substance puede recuperar la información de pintura si ignora la información alfa
> 
...
>[!NOTE]
>
> A diferencia de la herramienta Pintura, el Borrador solo permite definir qué canales se verán afectados. No es posible cargar un recurso desde la bandeja para que afecte a cada canal.
