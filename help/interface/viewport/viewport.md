...
La ventana gráfica es donde se muestran la malla 3D y sus texturas. Aquí es también donde es posible realizar la pintura en la superficie de la malla 3D.

## Información general

El mirador se divide en cuatro partes:

* **Barra de herramientas contextual**: esta barra de herramientas se encuentra en la parte superior de la ventana gráfica y ofrece método abreviado para varias propiedades en función del contexto actual (por ejemplo, parámetros de pincel al pintar).
...
El diseño predeterminado coloca la vista 3D a la izquierda y el Vista 2D a la derecha. Hay algunos parámetros disponibles en la **Barra de herramientas contextual** que permiten cambiar el diseño:
