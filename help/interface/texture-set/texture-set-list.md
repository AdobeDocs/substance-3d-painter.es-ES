...
* **Seleccionado** : El conjunto de texturas actual se está editando. Al seleccionar un conjunto de texturas, se actualizará la [pila de capas](../layer-stack/layer-stack.md) y la ventana [Configuración de sombreador](../shader-settings/shader-settings.md) en consecuencia.
...
## Administración de sombreadores

El botón situado a la derecha de cada nombre de conjunto de texturas se puede utilizar para administrar la asignación de sombreado.\
De forma predeterminada, cada conjunto de texturas comparte la misma instancia de sombreado. Sin embargo, a veces puede ser conveniente tener un sombreado diferente solo para una parte específica de la malla. Para ello, haga clic en el botón y elija &quot;**Nueva instancia de sombreado**&quot;. Desde allí, en la ventana [Configuración de sombreado](../shader-settings/shader-settings.md), es posible cambiar el sombreado y sus parámetros sin que esto afecte a otros conjuntos de texturas.
...
* **Importar parámetros de sombreado** : Permitir la importación de un archivo json para configurar los parámetros de sombreado de los conjuntos de texturas
