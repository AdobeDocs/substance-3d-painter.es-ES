...
breadcrumb-title: ''
description: Aprenda a configurar los ajustes del conjunto de texturas en Substance 3D Painter para controlar la resolución de texturas y las propiedades del canal.
...
| **Descripción** | Campo de texto que permite añadir información sobre un conjunto de texturas. Este texto se muestra en las ventanas [Texture Set list](texture-set-list.md) y [Baking](../../baking/baking.md). |
...
| --- | --- |
| <b>Agregar canal</b>  <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r1-column-c0_image" src="../../assets/channel-add.png" width="40px"/></div> | Haga clic en este botón para añadir un nuevo canal a la lista.El menú emergente que se abre se divide en tres categorías:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Canales compatibles</strong>: el sombreador actual puede utilizar estos canales en la ventana gráfica.</li><li data-preserve-html="true"><strong>Canales no compatibles</strong>: el sombreador actual omite estos canales en la ventana gráfica.</li><li data-preserve-html="true"><strong>Canales de usuario</strong>: canales adicionales para pintar más información, normalmente no admitidos por los sombreadores.</li></ul>  **Nota:** No hay límite en la cantidad de canales que se pueden agregar; sin embargo, demasiados canales pueden afectar gravemente al rendimiento y requerirán más memoria. |
...
Estos ajustes controlan distintos comportamientos sobre cómo se generan los canales, en particular, cómo se combinan los canales con las texturas horneadas (mapas de malla).

| Configuración | Descripción |
| --- | --- |
| **Mezcla normal** | Controla cómo se debe combinar el &quot;mapa normal al horno&quot; con el canal &quot;Normal&quot;. Los valores posibles son:<ul data-preserve-html="true"><li data-preserve-html="true"><strong> Reemplazar </strong> : Ignore el &quot;mapa normal al horno&quot; y solo utilizará el canal &quot;Normal&quot; para este conjunto de texturas. Se puede utilizar para pintar sobre un mapa normal horneado. Consulte la documentación de [pintura avanzada de canales](../../painting/advanced-channel-painting/normal-map-painting.md)para obtener más información. si el canal Normal no está presente o si la salida del canal Normal está vacía, se seguirá utilizando el mapa normal horneado.</li><li data-preserve-html="true"><strong> Combinar </strong> (predeterminado) : Utilice una función orientada a los detalles para combinar el canal &quot;Normal&quot; y el &quot;mapa normal al horno&quot;.</li></ul>  **Nota:** Esta configuración puede estar deshabilitada si falta el canal en la lista de canales. Si falta el canal, se utiliza el valor de mezcla predeterminado. |
| **Height al método normal** | Controla el método que se debe utilizar para convertir el canal de height en un mapa normal. Los valores posibles son:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Agudo</strong>: producir un mapa normal más definido con el riesgo de introducir ruido y suavizado. Adaptado para patrones repetitivos como telas.</li><li data-preserve-html="true"><strong>Suave (sobel)</strong> (predeterminado): producir un mapa normal más suave con un filtro Sobel con el riesgo de perder detalles. Adaptado para la mayoría de los casos.</li></ul> |
| **Mezcla de oclusión ambiental** | Controla cómo se debe combinar la &quot;oclusión ambiente al horno&quot; con el canal &quot;Oclusión ambiente&quot;. Los valores posibles son:<ul data-preserve-html="true"><li data-preserve-html="true"><strong> Reemplazar </strong> : Ignore la &quot;oclusión ambiente al horno&quot; y solo utilizará el canal &quot;Oclusión ambiente&quot; para este conjunto de texturas. Se puede utilizar para pintar sobre una oclusión de ambiente al horno. Consulte la documentación de [pintura avanzada de canales](../../painting/advanced-channel-painting/ambient-occlusion-painting.md) para obtener más información.  </li><li data-preserve-html="true"><strong> Multiplicar </strong> (predeterminado) : Utilice una operación de multiplicación para combinar el canal &quot;Oclusión ambiente&quot; y la &quot;oclusión ambiente horneada&quot;.  </li></ul>  **Nota:** Esta configuración puede estar deshabilitada si falta el canal en la lista de canales. Si falta el canal, se utiliza el valor de mezcla predeterminado. |
...
Los mapas de malla son texturas horneadas específicas de la malla y el conjunto de texturas que se utilizan para aumentar la calidad de las texturas con la ayuda de filtros, materiales inteligentes y máscaras inteligentes. Para obtener más información, consulta la documentación de [horneado](../../baking/baking.md).
