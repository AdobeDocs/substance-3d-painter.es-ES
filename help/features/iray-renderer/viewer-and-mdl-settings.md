...
* **Exposición del entorno** : Controlar el nivel de exposición del mapa de entorno HDR.
* **Rotación de entorno** : para cambiar la textura del entorno y rotarla.

>[!NOTE]
>
> Al tratarse de un procesador basado en la física, la textura de entorno define en gran medida la iluminación y el aspecto de la escena.
...
## Parámetros de MDL y Sombreador
...
De forma predeterminada, en Substance 3D Painter, una MDL está asociada a un sombreador GLSL, lo que permite cambiar entre el puerto de visualización normal y Irak sin tener que configurar nada.\
...
>[!NOTE]
>
> Para cargar MDL personalizados, se requiere un sombreador glsl personalizado.\
>  En el sombreador, se pueden añadir algunos metadatos para especificar la ruta de mdl :
> 
> //- Declare el material iray mdl a utilizar con este sombreador. //: metadata { //: &quot;mdl&quot;:&quot;mdl::alg::materials::Physical\_Metallic\_roughness::Physical\_Metallic\_roughness&quot; //: }
> 
...
| *Configuración* | *Descripción* |
| --- | --- |
| **Intensidad del Emisivo** | Multiplicador del canal del Emisivo. Un valor alto comenzará a emitir luz. <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table1_row-r1-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/emissive-optim.gif"/></div> |
