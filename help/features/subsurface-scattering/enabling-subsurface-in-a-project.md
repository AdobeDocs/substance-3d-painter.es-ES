...
## 3 - Configuración del sombreador

![](../../assets/shader-parameters.png)

En la ventana [Shader settings](../../interface/shader-settings/shader-settings.md) con sombreadores predeterminados, se encuentra un grupo &quot;**SSS Parameters**&quot; con dos valores.\
