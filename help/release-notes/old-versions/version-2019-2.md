...
**Substance Painter 2019.2** incorpora nuevas y potentes funciones a sus panaderos y ofrece un nuevo conjunto de materiales y máscaras inteligentes en la estantería.

Fecha de publicación : *25 de julio de 2019*

## Funciones principales

### Mejoras en el flujo de trabajo para panaderos

![](../../assets/header-image-vizu.jpg)

El flujo de trabajo de banca se ha mejorado con esta versión con algunas funciones nuevas. Estas mejoras agilizarán y facilitarán el trabajo diario con Substance Painter.

* **Visualización del proceso de cocción**\
  De forma predeterminada, con esta nueva versión, cualquier proceso de procesamiento será visible en la ventana gráfica. Permite previsualizar el resultado de los panaderos en tiempo real e incluso cancelarlo si es necesario sin esperar hasta el final del proceso para ofrecer iteraciones más rápidas. Este comportamiento se puede deshabilitar entrando en la configuración principal y desmarcando la configuración &quot;**Habilitar proceso de horneado de vista previa en vivo**&quot; en la sección &quot;**Opciones de horneado**&quot;.

  ![](../../assets/baking-options-v2.png)

  ![](../../assets/bake-process.gif){width="500px"}
* **Cuadro de diálogo de horneado mejorado**\
  El cuadro de diálogo de horneado se ha rediseñado y ahora muestra un estado mejor del proceso de horneado actual. Ahora hay un contador para indicar cuántas texturas se calcularán, así como una lista explícita por panadero y conjunto de texturas de lo que se está calculando. En caso de error, se muestra una cruz roja junto al nombre del panadero. Al final del proceso, un nuevo botón permite abrir rápidamente la ventana de registro para obtener más información sobre el problema.\
  ![](../../assets/baking-dialog.png)
* **Cancelando procesamiento en curso** El proceso de procesamiento ya no bloquea la aplicación. Substance Painter ahora es más receptivo, lo que significa que es posible cancelar una cocción que está actualmente en curso sin esperar a que finalice. Sin embargo, la cancelación no es inmediata y puede requerir unos segundos para que surta efecto. Esto se debe a que internamente el proceso de cocción funciona en texturas en fragmentos y no se puede detener mientras se está calculando un fragmento. Al cancelar el proceso de cocción, la ventana Horneado se vuelve a abrir automáticamente.\
  ![](../../assets/baking-cancel-optim.gif)

### Mejoras de rendimiento para panaderos

![](../../assets/header-image-baker.jpg)

Con la mejora del flujo de trabajo también aprovechamos para actualizar nuestros Bakers y mejorar sus prestaciones. También hemos añadido el soporte de DXR y Optix para permitir que el Trazado de rayos de GPU que permite hornear mucho más rápido que antes. Tenga en cuenta, sin embargo, que el Trazado de rayos de GPU solo afecta a la Oclusión ambiente y panadero de Thickness.

* **Se ha mejorado el seguimiento de la CPU**\
  El cálculo de trazado de rayos en la CPU es ahora de 2 a 3 veces más rápido que antes. Por lo tanto, aunque la GPU no sea compatible con Trazado de rayos de GPU, el rendimiento mejorará en general.
* **Soporte de Trazado de rayos de GPU con DXR y Optix**\
  Con el hardware compatible, los panaderos ahora pueden calcular directamente en la GPU, lo que reduce drásticamente el tiempo de cálculo, especialmente cuando se activa el suavizado y se definen muchos rayos. DXR es la opción predeterminada cuando está disponible; de lo contrario, se utilizará Optix. Es posible deshabilitar el Trazado de rayos de GPU yendo a la [configuración principal](../../interface/settings/settings.md) y buscando &quot;**Opciones de horneado**&quot;:
...
> DXR está disponible en GPU RTX y [GPU GeForce GTX 10xx](https://www.nvidia.com/en-us/geforce/news/geforce-gtx-dxr-ray-tracing-available-now/). DXR también requiere que Windows 10 esté actualizado para ser accesible (versión 1809). Consulte esta página para obtener más información.

>[!WARNING]
>
> Cuando se usa Trazado de rayos de GPU, el panadero puede fallar si la malla de alta polietileno no cabe en VRam. Cuando ocurra, se recomienda ir a la [configuración principal](../../interface/settings/settings.md) y deshabilitar la configuración &quot;**Trazado de rayos de GPU**&quot; en la sección &quot;**Opciones de horneado**&quot;. Después de eso, simplemente puede reiniciar el proceso de cocción.
...
Se ha añadido un nuevo conjunto de materiales y máscaras inteligentes al estante predeterminado para cubrir diversos usos. Esta es la lista completa de activos que se han añadido :

* **40 nuevos materiales inteligentes**
