---
helpx_url: "https://helpx.adobe.com/es/substance-3d-painter/release-notes/version-9-1.html"
breadcrumb-title: ''
...
<b>Substance 3D Painter 9.1</b> agrega control de tangente para la herramienta Ruta, soporte para el formato de archivo de SVG, la capacidad de importar y aplicar recursos mediante arrastrar y soltar, y soporte para la translucidez en la ventana gráfica.
...
* <b>Editar puntos de ruta mediante manipuladores</b>
  ...
  ![Las tangentes de ruta traducen el manipulador](../assets/path_tangents_translate.gif)
* <b>Alternar la visibilidad de las rutas de acceso individualmente</b>

  La visibilidad de los trazados ahora se puede cambiar por trazado mediante el panel de ventanilla dedicado. Al deshabilitar un trazado, se eliminarán sus contribuciones de las texturas finales sin tener que eliminarlo.
...
### Nuevo soporte para la translucidez, la transparencia y la absorción en la ventana gráfica
...
* <b>Nueva configuración de sombreador de ASM</b>
  ...
  * <b>Transparencia</b> (opacidad): Ya no es necesario cambiar a otro sombreado para obtener superficies transparentes, como follaje. En su lugar, habilite el parámetro <b>alpha test</b> o <b>alpha blending</b> en el grupo <b>Geometría > Opacidad</b>. También están disponibles los ajustes habituales, como el tramado.
  * <b>Transparencia</b>: esta nueva propiedad permite crear superficies como el cristal, haciendo que las formas sean transparentes y manteniendo los reflejos del specular. Para usarlo, agregue un canal de translúcida en su proyecto y habilite el parámetro <b>Translucency</b> en el grupo <b>Interior</b>.
...
* <b>Información sobre herramientas e interfaz de usuario de configuración de sombreado mejorada</b>
  ...
  Con el retrabajo del sombreado aprovechamos la oportunidad para mejorar la interfaz de usuario de los parámetros, así como para añadir muchas nuevas sugerencias de herramientas para descubrir más fácilmente cómo activarlos.
...
* <b>Nuevo proyecto de muestra para probar el material estándar de Adobe</b>

  La manipulación de las nuevas propiedades de ASM puede resultar difícil al principio, por lo que se ha añadido un nuevo proyecto de muestra que muestra varias funciones del sombreado para que sea más fácil aprenderlas.
...
* <b>El canal de transparencia ahora tiene como valor predeterminado un color negro</b>

  Para facilitar el uso de las nuevas propiedades de sombreado y evitar resultados inesperados en la ventana gráfica, el color predeterminado del canal Transparencia se ha cambiado a negro (en lugar de blanco).

  Si este canal ya estaba en uso en su proyecto, puede obtener el comportamiento anterior simplemente agregando una capa de relleno en la parte inferior de la pila de capas y estableciendo el valor del canal en blanco. Es posible que desee habilitar el ajuste <b>Usar translucidez como máscara de dispersión</b> en el parámetro del sombreado, así como volver a aplicar la contribución del canal al resultado de dispersión subsuperficial.

### Nueva compatibilidad con archivos de gráficos vectoriales (SVG)

![SVG de banner](../assets/v91_banner_svg.jpg)

Esta versión añade la compatibilidad de los archivos de SVG como recursos que se pueden utilizar en capas, herramientas de pintura, etc.
...
* <b>Importar archivos de SVG</b>\
  ...
  La importación también se ha hecho más fácil en esta versión (véase a continuación) para que el uso de archivos de SVG se pueda realizar simplemente arrastrando y soltando recursos de fuera de Painter directamente en la malla o la pila de capas.
...
* <b>Nuevos materiales adaptados para el SVG</b>
  ...
  * <b>Pintura en spray personalizada</b>: permite simular una pegatina pintada en una pared a partir de una sola imagen de entrada.
...
* <b>Usar modificadores de teclado para comportamientos avanzados</b>
  ...
  * <b>ALT</b> al colocar en la <b>pila de capas</b>: solo se aplica al soltar sobre una miniatura de capa. ALT eliminará todos los efectos anteriores. Se puede utilizar como una forma rápida de probar diferentes recursos, especialmente máscaras inteligentes, sin tener que eliminarlos manualmente primero.
...
* <b>Compresión sin pérdida de imágenes de 16 bits</b>
  ...
  Este cambio se dirige principalmente a <b>texturas de horneado</b>, que suelen ser la razón por la que los archivos de proyecto pueden ser muy pesados en el disco. En promedio, vimos proyectos <b>reducidos en un 30% a un 50% en tamaño en el disco</b>.
...
* <b>Nuevo modo de proyección de relleno UV establecido en UV</b>
  ...
  Se ha agregado un nuevo modo de proyección para capas/efectos de relleno denominado <b>Proyección de conjunto UV establecida en Proyección de conjunto UV</b>. Se puede utilizar para proyectar una textura basada en diferentes UV disponibles en la malla dentro del proyecto. Se puede utilizar para realizar una transferencia de texturas más avanzada sin necesidad de recurrir a herramientas externas.
...
* <b>Nuevas mejoras en la API de Python</b>
  ...
  * La ruta de texturas de exportación del proyecto ahora también se puede recuperar desde la API.
* <b>Nuevo envío a After Effects (beta)</b>

  Hay disponible una nueva función Enviar a acción para exportar una malla y su textura a After Effects, lo que facilita la iteración en efectos visuales. Esta función requiere el acceso mínimo a la versión beta 24.1 de After Effects.
