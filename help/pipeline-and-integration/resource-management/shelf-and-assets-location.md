...
helpx_learn_topic: ""
helpx_tags: ""
title: Ubicación de estantes y activos
...
# Ubicación de estantes y activos

Esta página muestra la ubicación de los activos (o estante para las versiones anteriores) de cada plataforma.Esta ruta es donde se encuentra de forma predeterminada el contenido del usuario (como guardar los ajustes preestablecidos en la ventana Activos ) y los complementos.
